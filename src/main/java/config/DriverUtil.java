...
public class DriverUtil {
  ...
  private static final String DOCKER_GRID_URL = "https://console.cloud.google.com/gcr/images/de-nc-gr-pr-global/EU/docker-base-images/system/test-automation-zalenium?project=de-nc-gr-pr-global&gcrImageListsize=30";
  ...
  static Path modHeaderExtension = Paths.get(
      System.getProperty("user.dir") + fileSeparator + "resources" + fileSeparator
          + "chrome_extension" + fileSeparator + "chrome_modheader.crx");
  ...
  public static RemoteWebDriver initDockerChrome(boolean incognito) {
    ...
    dc.setCapability(CapabilityType.BROWSER_NAME, Browser.CHROME);
    ...
    try {
      ...
      chromeOptions.setCapability(CapabilityType.LOGGING_PREFS, logPrefsCHROME);
...
//                dc.setCapability(ChromeOptions.CAPABILITY, chromeOptions);
  ...
  public static RemoteWebDriver initChromeSSH(boolean incognito, boolean proxy) {
    ...
    try {
      ...
      dcSSH.setCapability(CapabilityType.BROWSER_NAME, Browser.CHROME);
  ...
  public static RemoteWebDriver initFirefox(boolean incognito, boolean proxy) {
    ...
    options.setCapability("marionette", true);
    options.setAcceptInsecureCerts(true);
    //options.setCapability(CapabilityType.LOGGING_PREFS, logPrefsFOX);
  ...
  public static void initAndroidDriver() {
    ...
    switch (Hook.platform) {
      ...
      case "android-nativeApp":
        ...
        appiumSettingsStop = "adb -s " + System.getProperty("deviceUDID")
            + " shell am force-stop io.appium.settings";
      ...
      case "android-ssh":
        ...
        appiumSettingsStop = String.format(formatSSH,
            "adb -s " + System.getProperty("deviceUDID") + " shell pm clear io.appium.settings");
        appiumSettingsClear = String.format(formatSSH, "adb -s " + System.getProperty("deviceUDID")
            + " shell am force-stop io.appium.settings");
        executeSettingAdbAndAppium(startADB, appiumSettingsStop, appiumSettingsClear);
        break;
      default:
...
//        caps.setCapability("noReset", true);
  ...
  public static void openBrowser(String browserName) {
    threadLocalActiveBrowsers.get().put("initial", threadLocalDriver.get());
    threadLocalActiveBrowsers.get().put(browserName, initNewDriver(browserName, false, false));
  }

  public static void openBrowserWithIncognito(String browserName) {
    threadLocalActiveBrowsers.get().put("initial", threadLocalDriver.get());
    threadLocalActiveBrowsers.get().put(browserName, initNewDriver(browserName, true, false));
  }

  public static void openBrowserWithProxy(String browserName) {
    threadLocalActiveBrowsers.get().put("initial", threadLocalDriver.get());
    threadLocalActiveBrowsers.get().put(browserName, initNewDriver(browserName, false, true));
  }
...
//            else if (System.getProperty("executingEnv").contains("local"))
//                cmd = CommandLine.parse("appium -a 0.0.0.0 -p 4723");
    }
