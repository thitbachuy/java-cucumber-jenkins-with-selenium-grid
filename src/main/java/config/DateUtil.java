...
public class DateUtil {
  ...
  public static String getTestDataDateValue(String key, String value) {
    if (key.startsWith("@date:")) {
      ...
      String localDateTimeString = DateTimeFormatter.ofPattern("yyyyMMddHHmmssSSS").format(localDateTime);
  ...
  public static LocalDate calculateDateTime(String startDate, String value) {
    ...
    if (startDate.equals("today")) {
      ...
      newDate = LocalDate.parse(TestDataLoader.getTestData(newDateInfo[0]), DateTimeFormatter.ofPattern(newDateInfo[1]));
    }
    if (!value.equals("")) {
