...
public class AppiumServer {
    ...
    public AppiumServer() {
        ...
        if (systemOs.toLowerCase().contains("windows")) {
            appiumJsPath = environmentVariables.get("APPDATA") + "\\npm\\node_modules\\appium\\build\\lib\\main.js";
        ...
        appiumService = buildAppiumService(appiumJsPath, nodeJsPath, appiumServerHost, appiumServerPort, appiumServerBasePath);
    }
    ...
    public void start() {
        if (!appiumService.isRunning()) {
            ...
            LOG.info("Appium server already started at host: {}:{}{}", appiumServerHost, appiumServerPort, appiumServerBasePath);
    ...
    public void stop() {
        if (appiumService.isRunning()) {
            ...
            LOG.info("Appium server is not running at host: {}:{}{}", appiumServerHost, appiumServerPort, appiumServerBasePath);
    }
    ...
    private AppiumDriverLocalService buildAppiumService(String appiumJsPath, String nodeJsPath, String appiumServerHost, String appiumServerPort, String appiumServerBasePath) {
