...
public class TestDataLoader {
  ...
  public static Map<String, String> readJsonFile(String dataFileToLoad) {
        ...
        try {
            return mapper.readValue(new File("src/main/java/testdata/input/" + dataFileToLoad), new TypeReference<>() {
            });
    ...
    public static Map<String, String> mergeTestData(Map<String, String> common, Map<String, String> envSpecific) {
        if (common == null) {
    ...
    public static String getTestData(String key) {
        ...
        } else if (key.startsWith("@date:") || key.equals("@DateAsValue")  || key.equals("randomNumberUsingDateTime")) {
...
//          logger.info("Loading \"" + value + "\" as \"" + key + "\" from Test Data Set");
            ...
            value = key.equals("@BusinessHoursTest") ? tf.format(now.plusMinutes(Integer.parseInt(TestDataLoader.getTestData("@TD:businessHoursExtra")))) + "Z" : tf.format(now.minusMinutes(2)) + "Z";
        } else {
            value = key;
        }
        return value;
    ...
    public static void checkTestData(String key, String value){
      if (value == null) {
        ...
        if (lowercaseKey.contains("password") || lowercaseKey.contains("pw") || lowercaseKey.contains("pin") || lowercaseKey.contains("clientid") || lowercaseKey.contains("clientsecret") || lowercaseKey.contains("credentials") || lowercaseKey.contains("mailosaur_apikey")) {
